...
//    public static final String BaseUrl = "http://114.215.149.242:28080/ZFAgent/api";
    public static final String URL = "http://121.40.84.2:28080/ZFAgent";
    public static final String BaseUrl = URL+"/api";
//    public static final String BaseUrl = "http://121.40.64.167:9090/api";
    ...
    public static final String UrlGoodsSearchItem = BaseUrl + "/good/search";
    ...
    public static final String UrlCommentList = BaseUrl + "/comment/list";
    ...
    public static final String UrlBankList = BaseUrl + "/apply/chooseBank";
    ...
    public void onEventBackgroundThread(Events.GoodsSearchItemEvent event) {
        Events.CommonCompleteEvent completeEvent = new Events.GoodsSearchItemCompleteEvent();
        CommonRequest(event, completeEvent, UrlGoodsSearchItem);
    }
    ...
    public void onEventBackgroundThread(Events.GoodsCommentListEvent event) {
        Events.CommonCompleteEvent completeEvent = new Events.GoodsCommentListCompleteEvent();
        CommonRequest(event, completeEvent, UrlCommentList);
    }
    ...
    public void onEventBackgroundThread(Events.PrepareAgentListEvent event) {
        Events.CommonCompleteEvent completeEvent = new Events.PrepareAgentListCompleteEvent();
        CommonRequest(event, completeEvent, UrlPrepareAgentlList);
    }
    ...
    public void onEventBackgroundThread(Events.GetDefaultProfitEvent event) {
        Events.CommonCompleteEvent completeEvent = new Events.GetDefaultProfitCompleteEvent();
        CommonRequest(event, completeEvent, UrlGetDefaultProfit);
    }

    public void onEventBackgroundThread(Events.ChannelTradeListEvent event) {
        Events.CommonCompleteEvent completeEvent = new Events.ChannelTradeListCompleteEvent();
        CommonRequest(event, completeEvent, UrlChannelTradeList);
    }
    ...
    public void onEventBackgroundThread(Events.BankListEvent event) {
        Events.CommonCompleteEvent completeEvent = new Events.BankListCompleteEvent();
        CommonRequest(event, completeEvent, UrlBankList);
    }
